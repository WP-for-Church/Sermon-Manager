        ...
        <div id="the-list">
                ...
                <div class="plugin-card-top">
                    ...
                    <div class="action-links">
                        <ul class="plugin-action-buttons">
                            <li><a href="" class="button" aria-label="Import from file">Import</a></li>
            ...
            <div class="plugin-card">
                <div class="plugin-card-top">
                    ...
                    <div class="action-links">
                        <ul class="plugin-action-buttons">
                            <li><a href="" class="button activate-now"
                                   aria-label="Import from file">Export</a>
                            </li>
                            <li><a href="" class="" aria-label="More Details">More Details</a></li>
                        </ul>
                    </div>
            ...
            <div class="plugin-card">
                <div class="plugin-card-top">
                    ...
                    <div class="action-links">
                        <ul class="plugin-action-buttons">
                            <li><a href="" class="button activate-now"
                                   aria-label="Import from file">Import</a>
                            </li>
                            <li><a href="" class="" aria-label="More Details">More Details</a></li>
                        </ul>
                    </div>
