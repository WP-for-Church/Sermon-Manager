...
class Sermon_Manager_Settings {
	...
	function wpfc_add_options_page() {
		$page = add_submenu_page('edit.php?post_type=wpfc_sermon', __('Sermon Manager Settings', 'sermon-manager'), __('Settings', 'sermon-manager'), 'manage_options', __FILE__, array($this,'wpfc_sermon_options_render_form'));
	...
	function wpfc_sermon_options_render_form() {
		...
		<div class="wrap">
			...
			.ui-tabs-active a{background: #ffffff}
			</style>
			...
			<div id="post-body-content">
				...
				<div class="inside">
					...
					<tr valign="top" style="display:none;">
						...
						<td>
							<input type="text" size="65" name="wpfc_options[version]" value="<?php $Sermon_Manager_Upgrade = new Sermon_Manager_Upgrade();
							echo $Sermon_Manager_Upgrade->wpfc_plugin_get_version(); ?>" /> <span style="color:#666666;margin-left:2px;"><?php _e('Current Version', 'sermon-manager'); ?></span>
						</td>
					</tr>
					</table>
				</div> <!-- .inside -->
