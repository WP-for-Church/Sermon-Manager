		...
		register_taxonomy( 'wpfc_service_type',
			...
			apply_filters( 'sm_taxonomy_args_wpfc_service_type', array(
				...
				'labels'       => array(
					...
					'menu_name'         => _x( 'Service Types', 'Admin menu name', 'sermon-manager' ),
					...
					'add_new_item'      => __( 'Add new service type', 'sermon-manager' ),
					'new_item_name'     => __( 'New service type name', 'sermon-manager' ),
					'not_found'         => __( 'No service types found', 'sermon-manager' ),
				),
				'show_ui'      => true,
				'query_var'    => true,
				'show_in_rest' => true,
