...
function wpfc_podcast_add_head() {
	...
	<?php if ( trim( category_description() ) !== '' ) : ?>
		<itunes:summary><?php echo str_replace( '&nbsp;', '', \SermonManager::getOption( 'enable_podcast_html_description' ) ? stripslashes( wpautop( wp_filter_kses( category_description() ) ) ) : stripslashes( wp_filter_nohtml_kses( category_description() ) ) ); ?></itunes:summary>
	<?php else : ?>
		<itunes:summary><?php echo str_replace( '&nbsp;', '', \SermonManager::getOption( 'enable_podcast_html_description' ) ? stripslashes( wpautop( wp_filter_kses( \SermonManager::getOption( 'itunes_summary' ) ) ) ) : stripslashes( wp_filter_nohtml_kses( \SermonManager::getOption( 'itunes_summary' ) ) ) ); ?></itunes:summary>
	<?php endif; ?>
	<itunes:owner>
